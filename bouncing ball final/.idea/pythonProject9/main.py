...
girlOne = pygame.image.load('pngwing.com.png')
...
background = mixer.music.load("bensound-summer_mp3_music.mp3")  # The name of my music file is background.wav
...
while (isRunning):
    ...
    if girlOneY >= 480:  # This checks if the girl has reached around the CEO
        ...
        sound = mixer.Sound('Beep - Sound Effect.mp3')
        sound.play()
